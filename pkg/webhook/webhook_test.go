...
func TestWebhookServer_handleValidate(t *testing.T) {
			...
			request: admissionv1.AdmissionReview{
				Request: &admissionv1.AdmissionRequest{
					...
					Object: runtime.RawExtension{
						Raw: marshalPolicy(t, &v1alpha1.ZenCleanerPolicy{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodPost, "/validate-cleanup-policy", bytes.NewReader(body))
...
func TestWebhookServer_handleValidate_InvalidMethod(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/validate-cleanup-policy", http.NoBody)
	w := httptest.NewRecorder()
...
func TestWebhookServer_handleValidate_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/validate-cleanup-policy", bytes.NewReader([]byte("invalid json")))
	req.Header.Set("Content-Type", "application/json")
	w := httptest.NewRecorder()
...
func TestWebhookServer_handleMutate_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/mutate-cleanup-policy", bytes.NewReader([]byte("invalid json")))
	req.Header.Set("Content-Type", "application/json")
	w := httptest.NewRecorder()
...
func TestWebhookServer_handleMutate_InvalidMethod(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/mutate-cleanup-policy", http.NoBody)
	w := httptest.NewRecorder()
...
func marshalPolicy(t *testing.T, policy *v1alpha1.ZenCleanerPolicy) []byte {
	t.Helper()
...
func TestWebhookServer_handleMutate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(tt.method, "/mutate-cleanup-policy", bytes.NewBuffer(reqBody))
			req.Header.Set("Content-Type", "application/json")
			w := httptest.NewRecorder()
