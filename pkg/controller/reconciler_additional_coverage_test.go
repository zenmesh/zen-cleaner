...
// TestPolicyReconciler_matchesSelectors tests the matchesSelectors method.
func TestPolicyReconciler_matchesSelectors(t *testing.T) {
...
// TestPolicyReconciler_cleanupPolicyResources_Additional tests cleanup of policy resources.
func TestPolicyReconciler_cleanupPolicyResources_Additional(t *testing.T) {
	...
	policy1 := &v1alpha1.ZenCleanerPolicy{
...
// TestPolicyReconciler_getOrCreateResourceInformer_ErrorHandling tests error handling.
...
func TestPolicyReconciler_getOrCreateResourceInformer_ErrorHandling(t *testing.T) {
	t.Skip("Skipping due to complex informer setup requirements - better tested via integration tests")
}

// TestPolicyReconciler_deleteResource_DryRun tests dry run deletion.
func TestPolicyReconciler_deleteResource_DryRun(t *testing.T) {
	scheme := runtime.NewScheme()
	fakeClient := clientfake.NewClientBuilder().WithScheme(scheme).Build()
	dynamicClient := fake.NewSimpleDynamicClient(scheme)
...
// TestPolicyReconciler_deleteResource_ContextCancellation tests context cancellation.
func TestPolicyReconciler_deleteResource_ContextCancellation(t *testing.T) {
	scheme := runtime.NewScheme()
	fakeClient := clientfake.NewClientBuilder().WithScheme(scheme).Build()
	dynamicClient := fake.NewSimpleDynamicClient(scheme)
