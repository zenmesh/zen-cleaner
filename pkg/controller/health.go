...
import (
	...
	"github.com/zenmesh/zen-cleaner/internal/health"
)

// HealthChecker provides health check functionality for the Zen Cleaner controller.
// This now uses zen-cleaner/internal/pkg/health as the base implementation.
type HealthChecker struct {
	// Informer sync checker from zen-cleaner/internal
...
func NewHealthChecker(reconciler *PolicyReconciler) *HealthChecker {
	// Create informer sync checker using zen-cleaner/internal
