...
// TestPolicyReconciler_recordPolicyPhaseMetrics tests the recordPolicyPhaseMetrics function.
func TestPolicyReconciler_recordPolicyPhaseMetrics(t *testing.T) {
	...
	policy1 := &v1alpha1.ZenCleanerPolicy{
		...
		Status: v1alpha1.ZenCleanerPolicyStatus{
	...
	policy3 := &v1alpha1.ZenCleanerPolicy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "policy3",
			Namespace: "default",
			UID:       types.UID("uid-3"),
	...
	policy4 := &v1alpha1.ZenCleanerPolicy{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "policy4",
			Namespace: "default",
			UID:       types.UID("uid-4"),
