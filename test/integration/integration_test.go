...
func TestPolicyReconciler_Integration(t *testing.T) {
	...
	if reconciler == nil {
		t.Fatal("PolicyReconciler is nil")
	}
...
func TestPolicyReconciler_PolicyCRUD(t *testing.T) {
	scheme := runtime.NewScheme()
	if err := v1alpha1.AddToScheme(scheme); err != nil {
		t.Fatalf("Failed to add scheme: %v", err)
	}
...
// TestPolicyReconciler_PolicyDeletion tests that informers and rate limiters are cleaned up when a policy is deleted.
func TestPolicyReconciler_PolicyDeletion(t *testing.T) {
	scheme := runtime.NewScheme()
	if err := v1alpha1.AddToScheme(scheme); err != nil {
		t.Fatalf("Failed to add scheme: %v", err)
	}
...
// TestPolicyReconciler_InformerCleanup tests that informers are properly cleaned up.
func TestPolicyReconciler_InformerCleanup(t *testing.T) {
	scheme := runtime.NewScheme()
	if err := v1alpha1.AddToScheme(scheme); err != nil {
		t.Fatalf("Failed to add scheme: %v", err)
	}
...
// TestPolicyReconciler_RateLimiterBehavior tests rate limiter creation and cleanup.
func TestPolicyReconciler_RateLimiterBehavior(t *testing.T) {
	scheme := runtime.NewScheme()
	if err := v1alpha1.AddToScheme(scheme); err != nil {
		t.Fatalf("Failed to add scheme: %v", err)
	}
...
// TestPolicyReconciler_ErrorRecovery tests error recovery scenarios.
func TestPolicyReconciler_ErrorRecovery(t *testing.T) {
	scheme := runtime.NewScheme()
	if err := v1alpha1.AddToScheme(scheme); err != nil {
		t.Fatalf("Failed to add scheme: %v", err)
	}
...
// TestPolicyReconciler_MultiplePolicies tests handling of multiple policies.
func TestPolicyReconciler_MultiplePolicies(t *testing.T) {
	scheme := runtime.NewScheme()
	if err := v1alpha1.AddToScheme(scheme); err != nil {
		t.Fatalf("Failed to add scheme: %v", err)
	}
