...
// This package enables consistent event recording patterns across zen-cleaner, zen-lock, zen-watcher, and other components.
package events
...
// Component is the component name (e.g., "zen-cleaner", "zen-lock-controller").
