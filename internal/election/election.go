...
const DefaultElectionID = "zen-cleaner-leader-election"
...
type Config struct {
	...
	// OnLeadingChange is invoked on leadership transitions (SUPPORT2-003
	// §11: feeds the leadership-aware health server). Optional.
