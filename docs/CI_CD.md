...
This document describes the CI/CD pipeline and quality gates for zen-cleaner.

## Overview

zen-cleaner uses GitHub Actions for continuous integration, following Kubernetes and OSS best practices.
...
```bash
# Run specific test
go test -v ./pkg/controller -run TestCleanerController
