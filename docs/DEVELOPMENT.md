...
This guide covers development setup, workflows, and best practices for zen-cleaner.
...
```bash
git clone https://github.com/zenmesh/zen-cleaner.git
cd zen-cleaner
go mod download
```
