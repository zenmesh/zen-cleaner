...
This document describes image security practices for zen-cleaner, including base image pinning, security scanning, and update procedures.
...
# Scan image
trivy image zenmesh/zen-cleaner:latest

# Scan with specific severity
trivy image --severity CRITICAL,HIGH zenmesh/zen-cleaner:latest

# Scan and save report
trivy image --format json --output trivy-report.json zenmesh/zen-cleaner:latest
```
...
# Run security scan
trivy image zenmesh/zen-cleaner:test

# Test the image
docker run --rm zenmesh/zen-cleaner:test --help
```
